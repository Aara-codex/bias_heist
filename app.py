...
/* Widget labels sit on the dark navy background */
label, [data-testid="stWidgetLabel"] label, [data-testid="stWidgetLabel"] p {
    color: #f0ead9 !important;
}

/* Input boxes: dark-gray, premium look — separates from the page
   background without going light/parchment. */
input, textarea,
...
[data-baseweb="select"] > div {
    ...
    border: 1px solid #45455f !important;
}
input::placeholder, textarea::placeholder {
    color: #9494ab !important;
    opacity: 1 !important;
}
...
/* Sliders: consistent red for the active track/thumb */
...
/* Alert/remark boxes: force BOTH background and text explicitly —
   don't rely on Streamlit's own alert colors, which caused dark-on-dark */
[data-testid="stAlert"] {
    background-color: #2e2e42 !important;
    border-left: 4px solid #8579f0 !important;
}
...
[data-testid="stDataFrame"] * { color: #eaeaf2 !important; }
...
.rank-badge {
    ...
    background: linear-gradient(90deg, #6c5ce7, #8579f0);
    color: #ffffff;
    font-weight: 800;
...
.stButton>button:hover { background: #8579f0; color: #ffffff; }
[data-testid="stMetricValue"] { color: #8579f0; }
</style>
